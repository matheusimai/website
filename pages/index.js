    ...
    <article className="flex flex-col items-center">
      <section className="container max-w-4xl mx-auto pb-10 ">
        <div>
          ...
          <p className="text-lg text-stone-200 my-1">I've started my journey by messing around with HTML and CSS, recently been learning JavaScript and React. I'm also curious about Mobile Development!</p>
          <p></p>
        <div>
